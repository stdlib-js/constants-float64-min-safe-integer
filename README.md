...
```javascript
import FLOAT64_MIN_SAFE_INTEGER from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-min-safe-integer@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-float64-min-safe-integer/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/constants-float64-min-safe-integer/actions/workflows/test.yml?query=branch:v0.1.0
